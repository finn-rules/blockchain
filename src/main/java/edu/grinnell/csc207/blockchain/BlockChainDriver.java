...
public class BlockChainDriver {
    ...
    public static void main(String[] args) throws NoSuchAlgorithmException {
        if (args.length != 1) {
            System.out.println("Error! The blockchain takes one argument which "
                    + "should be the initial positive transaction");
            System.exit(0);
        }
            ...
            if (input != null) {
                switch (input) {
                    ...
                    case "append" -> {
                        ...
                        Block addBlock = new Block(blockChain.getSize(), 
                                num, blockChain.last.block.getHash(), nonce);
                    ...
                    case "help" -> {
                        ...
                        System.out.println("\tappend: appends a new "
                                + "block onto the end of the chain");
